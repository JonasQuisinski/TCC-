...
ALTER TABLE `grupos`
  ADD CONSTRAINT IF NOT EXISTS `fk_grupos_owner`
    FOREIGN KEY (`owner_id`) REFERENCES `usuarios`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
INSERT INTO usuarios (nome, email, senha, data_nascimento, status, is_admin, created_at) VALUES ('Admin', 'admin@dispexa.local', '40028922', '2025-01-01', 'ativo', 1, NOW());
